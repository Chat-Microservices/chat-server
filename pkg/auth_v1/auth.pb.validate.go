...
// Validate checks the field values on GetListLogsRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetListLogsRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetListLogsRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetListLogsRequestMultiError, or nil if none found.
func (m *GetListLogsRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetListLogsRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetListLogsRequestMultiError(errors)
	}

	return nil
}

// GetListLogsRequestMultiError is an error wrapping multiple validation errors
// returned by GetListLogsRequest.ValidateAll() if the designated constraints
// aren't met.
type GetListLogsRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetListLogsRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m GetListLogsRequestMultiError) AllErrors() []error { return m }

// GetListLogsRequestValidationError is the validation error returned by
// GetListLogsRequest.Validate if the designated constraints aren't met.
type GetListLogsRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e GetListLogsRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetListLogsRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetListLogsRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetListLogsRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetListLogsRequestValidationError) ErrorName() string {
	return "GetListLogsRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetListLogsRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sGetListLogsRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetListLogsRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetListLogsRequestValidationError{}
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, LogsResponseValidationError{
			...
			if err := v.Validate(); err != nil {
				return LogsResponseValidationError{
					field:  fmt.Sprintf("Logs[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
...
func (m *UserPassword) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetPasswordConfirm()); l < 5 || l > 20 {
		err := UserPasswordValidationError{
...
func (m *UserDetail) validate(all bool) error {
	...
	if !_UserDetail_Name_Pattern.MatchString(m.GetName()) {
		err := UserDetailValidationError{
			field:  "Name",
...
func (m *UserDetail) _validateHostname(host string) error {
...
func (m *UserDetail) _validateEmail(addr string) error {
...
var _UserDetail_Name_Pattern = regexp.MustCompile("^[A-Za-z]+( [A-Za-z]+)*$")
